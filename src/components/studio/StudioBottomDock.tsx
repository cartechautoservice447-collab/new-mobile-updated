  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={`flex flex-col items-center justify-center px-1.5 sm:px-5 py-[26px] sm:py-[52px] rounded-[24px] sm:rounded-[40px] transition-colors duration-200 cursor-pointer min-w-[50px] sm:min-w-[90px] ${
          activeTab === 'home'
            ? 'bg-white/[0.08] text-white shadow-lg'
            : 'text-slate-400 hover:text-white hover:bg-white/[0.04]'
        }`}
      >
        <Home className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5" />
      ...
      >
        <LayoutGrid className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5" />
      ...
      >
        <Folder className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5" />
      ...
      >
        <FileText className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5" />
      ...
      >
        <Sparkles className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5 text-cyan-300" />
        <span className="text-[10px] sm:text-sm font-bold tracking-tight">More</span>
      </button>

      {/* Subtle Divider with clean vertical margin */}
      <div className="h-12 sm:h-24 w-[1px] bg-white/25 mx-0.5 sm:mx-3 shrink-0" />

      {/* 6. Return to Classic View Button */}
      <button
        onClick={onReturnToClassic}
        className="flex flex-col items-center justify-center px-1.5 sm:px-5 py-[26px] sm:py-[52px] rounded-[24px] sm:rounded-[40px] text-blue-200 hover:text-white bg-blue-600/10 hover:bg-blue-600/20 border-transparent transition-colors duration-200 cursor-pointer min-w-[50px] sm:min-w-[90px] shadow-sm shrink-0"
        title="Return to Classic View"
        id="btn-return-classic-dock"
      >
        <Layers className="w-4 h-4 sm:w-7 sm:h-7 mb-1 sm:mb-2.5 text-blue-300" />
