...
export const OverviewModal: React.FC<OverviewModalProps> = ({
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex items-center justify-center p-2 sm:p-4 md:p-6 bg-black/40 backdrop-blur-[2px] animate-fade-in"
      onClick={(e) => {
    ...
    >
      <div
        ...
        className="relative w-full max-w-3xl rounded-[32px] sm:rounded-[36px] border border-white/20 text-white overflow-hidden max-h-[90vh] flex flex-col"
        style={glassCardStyle}
      >
        {/* Top Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 sm:py-5 border-b border-white/10 bg-white/[0.04]">
        ...
        <div className="p-4 sm:p-6 space-y-5 sm:space-y-6 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
            <div
              ...
              className="p-4 rounded-2xl border border-white/15 space-y-1"
              style={glassCardStyle}
            >
          ...
          <div
            id="overview-syllabus-panel"
            className="p-5 rounded-2xl border border-white/15 space-y-4"
            style={glassCardStyle}
          >
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                      {courseNotes.map((note, idx) => {
                        ...
                        return (
                          <div
                            key={note.id || idx}
                            className="flex items-center justify-between p-2.5 rounded-xl bg-white/[0.04] border border-white/10 text-xs hover:bg-white/10 transition-colors"
                          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div
              ...
              className="p-4 rounded-2xl border border-white/15 hover:border-cyan-400/50 cursor-pointer transition-all hover:scale-[1.01] flex items-center justify-between group"
              style={glassCardStyle}
            >
              ...
              <span className="px-3 py-1 text-xs rounded-xl bg-cyan-500/20 text-cyan-300 border border-cyan-400/30">
                Open →
              </span>
            </div>

            <div
              id="overview-action-2"
              onClick={() => {
                onClose();
                onOpenPomodoro?.();
              }}
              className="p-4 rounded-2xl border border-white/15 hover:border-purple-400/50 cursor-pointer transition-all hover:scale-[1.01] flex items-center justify-between group"
              style={glassCardStyle}
            >
              <div className="space-y-1">
