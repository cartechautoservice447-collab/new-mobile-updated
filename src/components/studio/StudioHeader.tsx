    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-2 sm:gap-3.5 self-stretch lg:self-auto justify-start lg:justify-end max-w-full">
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 p-1.5 rounded-2xl bg-black/20 border border-white/10 shadow-inner max-w-full">
          ...
          <button
            id="btn-ai-sparkle-header"
            onClick={onOpenAiSparkle}
            className="flex items-center gap-1.5 px-2.5 sm:px-3.5 py-2 sm:py-2.5 rounded-xl bg-white/10 hover:bg-white/20 border border-white/20 text-xs font-semibold text-white transition-all active:scale-95 cursor-pointer shadow-md"
        ...
        <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 p-1.5 rounded-2xl bg-black/20 border border-white/10 shadow-inner max-w-full">
          ...
          >
            {isDarkTheme ? <Sun className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-300" /> : <Moon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-cyan-300" />}
          </button>
          ...
          >
            <SlidersHorizontal className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-200" />
          </button>
